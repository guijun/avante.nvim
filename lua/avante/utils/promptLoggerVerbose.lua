...
function M.init()
  ...
  local log_file = Utils.join_paths(dir, "avante_prompts_verbose.log")
...
function M.log_prompt(request)
  ...
  local log_file = Utils.join_paths(log_dir, "avante_prompts_verbose.log")
